...
import { generateFromGraph, performReasoning } from '../services/geminiService';
                       ...
                       <div className="p-4 bg-zinc-900/30 space-y-5 animate-in slide-in-from-top-2">
                           ...
                           <div className="space-y-2 pt-2 border-t border-zinc-800/50">
                               <div className="flex justify-between items-center">
                                   ...
                                   <span className="text-[9px] text-zinc-600 font-mono uppercase">{resolution === '1K' ? 'Flash (Fast)' : 'Pro (HD)'}</span>
                               </div>
