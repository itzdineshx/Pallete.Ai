    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="bg-zinc-900 border border-zinc-700 rounded-2xl max-w-md w-full p-6 shadow-2xl animate-float">
        ...
        <p className="text-zinc-300 mb-6 leading-relaxed">
          PaletteAI uses <strong>Gemini 3 Pro</strong> for high-fidelity style transfer. 
          Please select a paid Google Cloud Project API key to continue.
        </p>

        <div className="bg-zinc-800/50 rounded-lg p-4 mb-6 text-sm text-zinc-400">
            Need billing help? <a href="https://ai.google.dev/gemini-api/docs/billing" target="_blank" rel="noreferrer" className="text-purple-400 hover:text-purple-300 inline-flex items-center gap-1">View Documentation <ExternalLink size={12}/></a>
        </div>
